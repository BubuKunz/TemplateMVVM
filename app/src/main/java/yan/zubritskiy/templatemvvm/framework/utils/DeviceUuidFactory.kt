...
/**
 * TODO: This one was taken from old implementation. Revise and see if it can be improved and warnings fixed
 */
class DeviceUuidFactory(context: Context) {
                ...
                if (uuid == null) {
                    ...
                    if (id != null) {
                        ...
                        try {
                            ...
                            uuid = UUID.fromString("0f14d0ab-0000-0000-0000-000000000000")
                        }
    ...
    fun getDeviceUuid(): UUID {
        return uuid ?: throw IllegalStateException("UUID should not be null")
    }
}